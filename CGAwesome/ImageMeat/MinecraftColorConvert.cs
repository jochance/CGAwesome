...
namespace CGAwesome.ImageMeat
{
    ...
    public static class MinecraftColorConvert
    {
        ...
        public static Dictionary<Color, string> GetColorToMinecraftBlockDictionary(string blockName, bool forTransparency, bool useJsPrefix, string transparencyBlockName)
        {
            var d = new ColorToMinecraftBlockDictionary();
            var jsPrefixString = useJsPrefix ? "minecraft:" : "";
